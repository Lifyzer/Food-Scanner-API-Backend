...
//                $newArr['product'][] = $product;
			...
			//print_($product_array = ['product_name' => validateValue($value['product_name'], "")]);
...
//                    }
            	...
            	$message = "No Product Available1";
            }

			}
			else{
			
            	$message = "No Product Available2";
            }
            	...
            	$message = "No Products Available3";
            }
